...
vim.diagnostic.config({
    ...
    signs = {
        ...
        -- linehl = {
        --     [vim.diagnostic.severity.ERROR] = "ErrorMsg", // using lsp_lines to show instead
        -- },
        numhl = {
...
lspui.default_options.border = NeoVim.ui.float.border or "rounded"
