...
local normal_mode_mappings = {
    ...
    ["/"] = {
        ...
        d = { "<cmd>Lazy<CR>", "Lazy dashboard" },
        s = { "<cmd>Lazy sync<CR>", "Lazy update plugins" },
    },
    ...
    g = {
        ...
        b = { '<cmd>lua require("config.git.blame").open()<CR>', "blame" },
        ...
        l = {
            name = "Log",
            a = { '<cmd>lua require("config.plugins.telescope").my_git_commits()<CR>', "commits (Telescope)" },
            c = { '<cmd>lua require("config.plugins.telescope").my_git_bcommits()<CR>', "buffer commits (Telescope)" },
        },
        m = { "blame line" },
    },
    ...
    s = {
        ...
        c = { '<cmd>lua require("config.plugins.telescope").command_history()<CR>', "command history" },
    },
